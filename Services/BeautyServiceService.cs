...
public class BeautyServiceService
{
    private readonly List<BeautyService> _services = new()
    {
        ...
        new BeautyService { Id = 105, SalonId = 1, SalonName = "NailBook Studio Vitosha", Name = "SPA терапия за ръце", Description = "Хидратация, масаж и подхранваща грижа за кожата на ръцете.", Category = "Грижа", DurationMinutes = 40, Price = 45, IsPopular = true },
        ...
        new BeautyService { Id = 303, SalonId = 3, SalonName = "NailBook Bulgaria Mall", Name = "Хром ефект", Description = "Перлен или огледален ефект върху готов маникюр.", Category = "Декорация", DurationMinutes = 25, Price = 22, IsPopular = true },
        ...
        new BeautyService { Id = 305, SalonId = 3, SalonName = "NailBook Bulgaria Mall", Name = "Декорация с камъчета", Description = "Акцентни камъчета и луксозен завършек.", Category = "Декорация", DurationMinutes = 30, Price = 25, IsPopular = false },

        // Salon 4: Paradise Center 
        new BeautyService { Id = 401, SalonId = 4, SalonName = "NailBook Paradise Center", Name = "Luxury гел лак", Description = "Premium база, цвят и топ с лъскав завършек.", Category = "Маникюр", DurationMinutes = 75, Price = 65, IsPopular = true },
        new BeautyService { Id = 402, SalonId = 4, SalonName = "NailBook Paradise Center", Name = "Nail Art дизайн", Description = "Ръчно рисувани декорации според снимка или идея на клиента.", Category = "Декорация", DurationMinutes = 60, Price = 40, IsPopular = true },
        new BeautyService { Id = 403, SalonId = 4, SalonName = "NailBook Paradise Center", Name = "Изграждане с гел - дълга форма", Description = "Изграждане с по-дълга форма и прецизна архитектура.", Category = "Изграждане", DurationMinutes = 150, Price = 120, IsPopular = false },
        new BeautyService { Id = 404, SalonId = 4, SalonName = "NailBook Paradise Center", Name = "Френски маникюр с декорация", Description = "Френски стил с фин акцент, брокат или камъчета.", Category = "Дизайн", DurationMinutes = 100, Price = 85, IsPopular = false },
        new BeautyService { Id = 405, SalonId = 4, SalonName = "NailBook Paradise Center", Name = "Парафинова терапия", Description = "Интензивна грижа за сухи ръце и кутикули.", Category = "Грижа", DurationMinutes = 35, Price = 38, IsPopular = true },
        ...
        new BeautyService { Id = 503, SalonId = 5, SalonName = "NailBook Mladost", Name = "Къс френски маникюр", Description = "Нежен френски маникюр за къса естествена дължина.", Category = "Маникюр", DurationMinutes = 70, Price = 52, IsPopular = false },
        new BeautyService { Id = 504, SalonId = 5, SalonName = "NailBook Mladost", Name = "Ремонт на два нокътя", Description = "Корекция на до два счупени нокътя.", Category = "Поддръжка", DurationMinutes = 30, Price = 18, IsPopular = false },
